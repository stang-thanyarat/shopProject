                    ...
                    <th>
                        ...
                        <div class="row">
                            <div class="col leftname">
                                ...
                                <input name="employee_firstname" type="text" id="employee_firstname" class="bb"
                                       required/>
                                <div class="c">*</div>
                            </div>
                            <div class="col leftlastname">
                                <label for="employee_lastname">นามสกุล :</label>
                                <input name="employee_lastname" type="text" id="employee_lastname" class="bb" class="bb"
                                       required/>
                                <div class="d">*</div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col leftidcardnumber">
                                ...
                                <input name="employee_card_id" type="text" id=employee_card_id onkeyup="autoTab(this)"
                                       class="bb"/>
                                <div class="e">*</div>
                            </div>
                    ...
                    <th>
                        <div class="row">
                            <div class="col lefttelephone">
                                ...
                                <input name="employee_telephone" type="text" id=employee_telephone
                                       onkeyup="autoTab2(this)" class="bb"/>
                                <div class="g">*</div>
                            </div>
                            <div class="col leftemail">
                                <label for="employee_email">อีเมล :</label>
                                <input name="employee_email" type="text" id="employee_email" onblur='check_email(this)'
                                       class="bb"/>
                                <div class="h">*</div>
                            </div>
                        </div>
                        <div class="col leftaddress">
                            ...
                            <textarea name="employee_address" id="employee_address" type="text" cols="40" rows="5"
                                      class="cc" style="vertical-align:top;" required></textarea>
                        </div>

                        <div class="row">
                            <div class="col leftn">สำเนาบัตรประชาชน :
                                <input type="file" accept="image/*" id="employee_card_id_copy"
                                       name="employee_card_id_copy" class="bb" required>
                                <div class="j">*</div>
                            </div>
                            <div class="col leftnb">สำเนาทะเบียนบ้าน :
                                <input type="file" accept="image/*" id="employee_address_copy"
                                       name="employee_address_copy" class="bb" required>
                                <div class="k">*</div>
                            </div>
                ...
                <tr>
                    <th>
                        <div class="col d-flex justify-content-end">
                            <button type="button" id="addmodel_btn" class="btn btn-primary1" data-bs-toggle="modal"
                                    data-bs-target=".bd-example-modal-sm">เพิ่มบัญชีใหม่
                            </button>
                        </div>
        </div>
        <table class="wh m">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <button type="button" class="btn-close" id="closedelrow" data-bs-dismiss="modal"
...
<div class="modal fade bd-example-modal-xl1" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
     aria-hidden="true">
