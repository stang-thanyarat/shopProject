...
<body>
    <form action="controller/Product.php" name="form1" id="form1" method="POST" enctype="multipart/form-data">
        <input type="hidden" name="product_img1" value="<?= $e['product_img1']; ?>" />
        <input type="hidden" name="product_img2" value="<?= $e['product_img2']; ?>" /> <input type="hidden" value="product" name="table" />
