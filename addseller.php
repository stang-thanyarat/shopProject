        ...
        <div class="col-11">
            ...
            <div class="row">
                <div class="col leftaddress">
                    ...
                    <textarea name="sell_address" id="sell_address" cols="40" rows="5" class="cc"
            ...
            <div class="row">
                <div class="col leftnumber2">
                    ...
                    <input type="text" name="seller_telephone" id="seller_telephone" onkeyup="autoTab2(this)"
                           class="bb"/>
                    <div class="j">*</div>
                </div>
            ...
            <div class="row">
                <div class="col leftfile">
                    บัตรประชาชน : <input type="file" accept="image/*" name="seller_card_id" id="seller_card_id"
                                         class="bb"
                                         required>
                    <div class="k">*</div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col leftfile3">
                    เอกสารอื่นๆ : <input type="file" accept="image/*" name="sell_documents" id="sell_documents"
                                         class="bb">
                </div>
            </div>
            ...
            <div class="row">
                <div class="col leftnote">
                    ...
                    <textarea name="sell_note" id="sell_note" cols="50" rows="5" style="vertical-align:top;"
                              class="bb"></textarea>
                </div>
            </div>
            <div class="row btn-g">
