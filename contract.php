    ...
    <form name="form1" action="" onsubmit="checkForm(); return false;">
        <div class="row">
            ...
            <div class="col-11">
                ...
                <div class="col xx">และยอมส่งมอบทรัพย์สินที่ขายให้แก่ผู้ซื้อวันที่&nbsp;<span>&nbsp;<input type="date" name="selldate" id="selldate" required></span> และผู้ขายได้รับราคาดังกล่าวแล้วไปจากผู้ซื้อเสร็จแล้วตั้งแต่วันที่&nbsp;<span>&nbsp;<input type="date" name="payDate" required></span></div>
            ...
            <div class="row">
                <div class="col d-flex justify-content-end rr">ลงชื่อ &nbsp; &nbsp;
                    <select name="witnessprefix1" id="witnessprefix1" style="background-color: #D4DDC6;" required>
            ...
            <div class="row">
                <div class="col d-flex justify-content-end rr">ลงชื่อ &nbsp; &nbsp;
                    <select name="witnessprefix2" id="witnessprefix2" style="background-color: #D4DDC6;" required>
                        <option value="นาย" selected>นาย</option>
                        <option value="นาง">นาง</option>
                        <option value="นางสาว">นางสาว</option>
                    </select>&nbsp;&nbsp;
            ...
            <div class="row">
                <div class="col d-flex justify-content-end rr">ลงชื่อ &nbsp; &nbsp;
                    <select name="witnessprefix3" id="witnessprefix3" style="background-color: #D4DDC6;" required>
                        <option value="นาย" selected>นาย</option>
                        <option value="นาง">นาง</option>
                        <option value="นางสาว">นางสาว</option>
                    </select>&nbsp;&nbsp;
