...
<tr class="setcenter">
 ...
 <tr class="setcenter">
   ...
   <td width="361" class="setcenter">รายละเอียด</td>
   <td width="162" class="setcenter">จำนวน </td>
   <td width="451" class="setcenter">หน่วยละ </td>
 ...
 <tr>
   ...
   <td width="451" class="setright">ยอดรวม : xxx &nbsp;</td>
   <td width="238" class="setright">xxx &nbsp;</td>
 </tr>
  <tr>
   <td colspan="3">&nbsp;</td>
   <td width="451" class="setright">ยอดรวมสุทธิ : xxx &nbsp;</td>
   <td width="238" class="setright">xxx &nbsp;</td>
 </tr>
</table>
</td>
...
<table width="1000" border="0">
<tr class="setcenter">
<td colspan="2">ลงชื่อ.............................ผู้ส่งของ</td>
<td colspan="2">ลงชื่อ.............................ผู้รับของ</td>
</tr>
</table>
</table>
</body>
