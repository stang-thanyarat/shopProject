                        ...
                        <?php foreach ($rows as $row) { ?>
                            <?php if ($row['payment_sl'] == "เงินสด") { ?>
                                <tr>
                                    ...
                                    <th>
                                        <a href="./service/PDF/template/receipt.php?id=<?= $row['sales_list_id'] ?>"><img src="./src/images/print.png" class="g" width="25"></a>
                                    </th>
                        ...
                        <?php foreach ($rowc as $rowq) { ?>
                            <?php if ($rowq['payment_sl'] == "ผ่อนชำระ" && $rowq['outstanding'] == "0") { ?>
                                <tr>
                                    ...
                                    <th>
                                        <a href="./service/PDF/template/invoice2.php?id=<?= $rowq['sales_list_id'] ?>"><img src="./src/images/print.png" class="g" width="25"></a>
                                    </th>
