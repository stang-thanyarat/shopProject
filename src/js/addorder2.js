...
$("#addproduct").submit(function (event) {
    ...
    $('#list-product').append(`<tr id="rr${i}">
                    ...
                    <th>
                        ...
                        <button type="button" class="btn1" data-bs-toggle="modal" data-bs-target=".bd-example-modal-sm2"><img src="./src/images/icon-pencil.png" width="25" onclick="saveIndexEdit(${i})"></button>
                    </th>
                </tr>`)
    $('#addclose').click()
    tableObj.data.push({
...
$("#addotherexpenses").submit(function (event) {
    ...
    $('#otherexpensestable').append(`<tr id="rr${i}">
                    ...
                    <th>
                        <button type="button" class="bgs" data-bs-toggle="modal" data-bs-target="#exampleModal1"><img src="./src/images/icon-delete.png" width="25" onclick="saveIndexDel(${i})"></button>
