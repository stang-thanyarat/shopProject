...
class Product
{
    ...
    public function insert($data)
    {
        ...
        $stmt = $this->conn->prepare($sql);
        $stmt->execute();
        $sql = "INSERT INTO product_tb (product_name, category_id, brand, model, sell_id, product_detail, product_img, product_detail_img, product_dlt_unit, product_unit, price, cost_price, notification_amt, sales_status/*, product_rm_unit, product_exchange_id*/) 
        VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?/*,?,?*/)";
        $stmt = $this->conn->prepare($sql);
