    ...
    <div class="row">
        ...
        <div class="col-11">
            ...
            <div class="row-3 xx">ข้าพเจ้า  <select name="employee_id" id="employee_id" class="bb selectsis" style="background-color: #D4DDC6;" required>
                    ...
                    <?php $count = 1; foreach ($laber as $s) {  $count++;?>
            ...
            <div class="row">
                ...
                <div class="col datec">
                    วันที่ทำสัญญา :
                    <input type="date" name="date_contract" id="date_contract" class="bb"
                           value="<?= $c['date_contract']; ?>" required/>
                    <div class="b">*</div>
                </div>
            </div>
            <div class="row">
                <div class="col owner">
                    ...
                    <select name="employee_id" id="employee_id" class="bb selectsis" style="background-color: #D4DDC6;"
                            required>
        ...
        <div class="row">
            <div class="col customerp">ข้าพเจ้า :
                <select name="customer_prefix" id="customer_prefix" style="background-color: #D4DDC6;" class="bb"
                        value="<?= $c['customer_prefix']; ?>" required>
                    <option value="เลือกคำนำหน้า" selected hidden>เลือกคำนำหน้า</option>
                    <option value="นาย">นาย</option>
                    <option value="นาง">นาง</option>
                    <option value="นางสาว">นางสาว</option>
            ...
            <div class=" col namec">ชื่อ : <input type="text" name="customer_firstname" id="customer_firstname"
                                                  class="bb" value="<?= $c['customer_firstname']; ?>" required/>
                <div class="f">*</div>
            </div>
        </div>
        <div class="row">
            <div class="col lastc">นามสกุล : <input type="text" name="customer_lastname" id="customer_lastname"
                                                    class="bb" value="<?= $c['customer_lastname']; ?>" required/>
                <div class="g">*</div>
            </div>
            <div class="col idcard">รหัสบัตรประชาชน : <input type="text" name="customer_img" id="customer_img"
                                                             class="bb" value="<?= $c['customer_img']; ?>" required/>
                <div class="h">*</div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col d-flex justify-content-end rr">ลงชื่อ &nbsp; &nbsp;
                ...
                นามสกุล : &nbsp; &nbsp;<input type="text" name="lastname1" id="lastname1" required/>&nbsp;&nbsp;
                พยานคนที่ 1
            </div>
        </div>
        <div class="row">
            <div class="col d-flex justify-content-end rr">ลงชื่อ &nbsp; &nbsp;
                ...
                นามสกุล : &nbsp; &nbsp;<input type="text" name="lastname2" id="lastname2" required/>&nbsp;&nbsp;
                พยานคนที่ 2
            </div>
        </div>
        <div class="row">
            <div class="col d-flex justify-content-end rr">ลงชื่อ &nbsp; &nbsp;
                ...
                นามสกุล : &nbsp; &nbsp;<input type="text" name="lastname3" id="lastname3" required/>&nbsp;&nbsp;
                พยานคนที่ 3
            </div>
        </div>
        <div class="row">
            <div class="col d-flex justify-content-end rrs">ลงชื่อ &nbsp; &nbsp;
                ...
                นามสกุล : &nbsp; &nbsp;<input type="text" name="lastnameseller" id="lastnameseller" required/>&nbsp;&nbsp;
                ผู้ขาย
            </div>
        </div>
        <div class="row">
            <div class="col d-flex justify-content-end rrp">ลงชื่อ &nbsp; &nbsp;
                ...
                นามสกุล : &nbsp; &nbsp;<input type="text" name="lastnamepurchaser" id="lastnamepurchaser" required/>&nbsp;&nbsp;
                ผู้ซื้อ
            </div>
        </div>
        <div class="row xx">๑. หากผู้ขายยังไม่ส่งมอบทรัพย์ให้ในเวลาทำสัญญา ควรจะเติมข้อความอีก ๑
            ข้อว่าตราบใดที่ผู้ขายยังไม่ส่งมอบทรัพย์ให้ ยังไม่ถือว่าได้มีการซื้อขาย มิฉะนั้นผู้ซื้ออาจเสียเปรียบผู้ขาย
        </div>
        <div class="row xx">๒. สัญญาซื้อขายไม่ต้องปิดอากรแสตมป์ เว้นแต่จะถือว่าสัญญานี้เป็นใบรับเงินแล้ว
            ถ้าสัญญาซื้อขายนี้ตั้งแต่ ๑๐ บาท ถึง ๒๐ บาท ต้องติดอากรแสตมป์ ๑๐ สตางค์ ถ้าสัญญาซื้ขายนี้เกิน ๒๐ บาท ทุก ๒๐
            บาท หรือเศษของ ๒๐ บาท ต่อ ๑๐ สตางค์ ถ้าสัญญาซื้อขายต่ำกว่า ๑๐ บาท ไม่ต้องติดอากรแสตมป์
        </div>
        <div class="row btn-g">
            <div class="col-2 buttom">
                <input type="submit" class="btn-c submit" value="บันทึก"/>
