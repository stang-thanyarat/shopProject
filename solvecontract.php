            ...
            <div class="col-11">
                ...
                <div class="row">
                    <div class="col owner">
                        ...
                        <select name="employee_id" id="employee_id" class="bb selectsis" style="background-color: #D4DDC6;" value="<?= $c['employee_id']; ?>" required></select>
                    </div>
                ...
                <div class="row">
                    <div class="col customerp">ข้าพเจ้า :
                        <select name="customer_prefix" id="customer_prefix" style="background-color: #D4DDC6;" class="bb" value="<?= $c['customer_prefix']; ?>" required>
