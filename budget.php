            ...
            <div class="col-11">
                ...
                <div class="d-flex flex-row-reverse">
                    ...
                    <div class="row main q">
                        <div class="col-12 a">
                            <input type="date" value="<?= date('Y-m-d') ?>" id="firstdate" name="firstdate" required>&nbsp ถึง &nbsp<input type="date" value="<?= date('Y-m-d') ?>" id="lastdate" name="lastdate" required>
