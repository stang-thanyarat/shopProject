            ...
            <div class="row main">
                ...
                <form action="productexchangehistory.php" method="GET">
                    ...
                    <div class="col-3 addpdr d-flex justify-content-end signin">
                        <a type="button" href="./searchinformation.php" class="submit btn"><img class='plus'
                ...
                <table class="col-11 pdrtb">
                    ...
                    <?php foreach ($rows as $row) { ?>
                        <tr>
                            ...
                            <th width=20%><?php if ($row['exchange_status'] == 0) {
                                    echo "<a type='button' onclick='wait()'><font color=#A36627>รอของ</font></a>";
                                } else {
                                    echo "สำเร็จ";
                                } ?></th>
                            <th>
                                <button type="button" class="bgs" onclick="del(<?= $row["product_exchange_id"] ?>)"><img
                                            src="./src/images/icon-delete.png" width="25"></button>
                                <a href="editproductexchange.php?id=<?= $row['product_exchange_id']; ?>" type="button"
                                   class="bgs"><img src="./src/images/icon-pencil.png" width="25"></a>
                            </th>
                        </tr>
                    <?php } ?>
                    </tbody>
...
<!-- ลบ -->
<div class="modal fade bd-example-modal-sm1" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel"
     aria-hidden="true">
